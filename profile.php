                ...
                <div class="content">
                    ...
                    <div class="overview">
                        ...
                        <div class="list-top-events">
                            ...
                            <?php
                                if ($_SESSION['isAdmin']){
                                    $statement_topevents = $connection->prepare("SELECT tblevents.eventID, eventName, eventType, image, isDelete, COUNT(tbluserevents.eventID) AS total_join 
                                    ...
                                    $statement_upcoming_events = $connection->prepare("SELECT tblevents.eventID, eventName, eventType, date, time, image, isDelete FROM tblevents INNER JOIN tbluserevents ON tblevents.eventID=tbluserevents.eventID AND tbluserevents.userID=? AND tblevents.date >= CURDATE() ORDER BY tblevents.date ASC, tblevents.time ASC");
                    ...
                    <div class="list-top-events all-admin-events">
                        ...
                        <?php
                            ...
                            // <?php endwhile; 
                                ...
                                $statement_userEvents = $connection->prepare("SELECT tblevents.eventID, eventName, eventType, image, isDelete FROM tblevents INNER JOIN tbluserevents ON tblevents.eventID = tbluserevents.eventID AND tbluserevents.userID=? ORDER BY tblevents.date DESC, tblevents.time DESC");
                                ...
                                while($e = $res_adminEvents->fetch_assoc()){
                                    if ($e['isDelete']){
                                        ...
                                        <div class="event-content">
                                            ...
                                            <div class="delete-update">
                                                <div>
                                                    <a href="includes/enableEvents.php?eventID='.$e['eventID'].'">
                                                        RESTORE
                                                    </a>
                                                </div>
                                            </div>
